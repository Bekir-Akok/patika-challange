        ...
        <body>
          <div class="payment-container">
            ...
            <form id="paymentForm">
              ...
              <input type="hidden" id="blockchain" name="blockchain" value="${
                wallets.length > 0 ? wallets[0].blockchain : ""
              }">
          ...
          <script>
            document.addEventListener('DOMContentLoaded', function() {
              ...
              const blockchainInput = document.getElementById('blockchain');
              ...
              networkSelect.addEventListener('change', function(e) {
                ...
                blockchainInput.value = blockchain;
              ...
              if (networkSelect.options.length > 0) {
                ...
                blockchainInput.value = firstOption.getAttribute('data-blockchain');
            ...
            document.getElementById('paymentForm').onsubmit = async function(e) {
              ...
              const blockchain = e.target.blockchain.value;
              ...
              const response = await fetch('${
                ...
                body: JSON.stringify({ amount, workshopId, selectedAddress, selectedAddressId, transferAddress, blockchain })
              });
